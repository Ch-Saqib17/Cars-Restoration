...
const page = () => {
  return (
    <div>
      ...
      {/*=======Pricing Plan======= */}
      <div className="flex flex-col md:flex lg:flex-row justify-center px-4 p-0 md:p-6 lg:p-6 gap-6">
        {/*Left Box */}
        <div className="w-full h-[580px] bg-gray-200 text-center flex flex-col">
        ...
        {/*center Box */}
        <div className="w-full h-[580px] bg-blue-500 text-center flex flex-col">
        ...
        {/*Right Box */}
        <div className="w-full h-[580px] bg-red-600 text-center flex flex-col">
          <div className="text-2xl font-bold tracking-tight text-white mt-4 uppercase">
            Luxury{" "}
          </div>
          <div className="text-white">Ac tincidunt ligula himenaeos </div>
