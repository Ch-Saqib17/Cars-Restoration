...
const Hero17 = () => {
  return (
    <div className="flex flex-col justify-center items-center">
      <div className="uppercase text-xl md:text-2xl lg:text-3xl font-extrabold tracking-tight">
      ...
      <div className="flex gap-4 mt-4">
        <div>
          ...
          >
            <div className="w-14 h-14 bg-red-500 flex justify-center items-center rounded-md">
              {" "}
              <svg
