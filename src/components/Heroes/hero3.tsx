    ...
    <div className="">
      ...
      <div className="flex-row text-center -mt-[200px] px-[50px] md:-mt-[400px] md:px-[200px]  lg:-mt-[500px] lg:px-[300px]">
        <div className="mb-2 md:mb-3 lg:mb-4">
          <span className="text-lg md:text-2xl lg:text-5xl font-extrabold text-white mb-6">
      ...
      <section className="flex justify-center mx-6 mb-10  ">
        <div className="flex-row md:flex lg:flex pt-6 md:pt-6 lg:pt-[200px] gap-x-[30px]">
          {/*First Box */}
          <div className="grid justify-center items-center text-center  bg-gray-200 shadow-lg w-96 h-[200px] lg:w-96 lg:h-60 md:w-60 md:h-40 mb-8 md:mb-0 lg:mb-0">
            {/*Circle */}
            <div className="flex justify-center items-center w-20 h-20 bg-red-500 rounded-full ml-40">
              <svg
            ...
            {/*data */}
            <div className="text-2xl font-bold">Body repair </div>
            <div>
          ...
          <div className="grid justify-center items-center text-center  bg-gray-200 shadow-lg w-96 h-[200px] lg:w-96 lg:h-60 md:w-60 md:h-40 mb-8 md:mb-0 lg:mb-0">
            ...
            {/*data */}
            <div className="text-2xl font-bold">Body Painting </div>
            <div>
              Cursus class si non luctus proin ridiculus at porttitor tempus
              feugiat sollicitudin{" "}
            </div>
          ...
          <div className="grid justify-center items-center text-center  bg-gray-200 shadow-lg w-96 h-[200px] lg:w-96 lg:h-60 md:w-60 md:h-40 mb-8 md:mb-0 lg:mb-0">
            ...
            {/*data */}
            <div className="text-2xl font-bold">Auto Bodycare </div>
            <div>
              Cursus class si non luctus proin ridiculus at porttitor tempus
              feugiat sollicitudin{" "}
            </div>
